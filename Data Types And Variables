...
// num2 but not num1?
//The difference between the values for the above exercises is as follows: The first question of the exercise is asking for values between 2 and 9 because they specifically ask for values GREATER than one and LESS than 10. Whereas in the the second part the question ask for values between 1 and 10 because of the use equal to.
...
//This exercise was somewhat easy.
